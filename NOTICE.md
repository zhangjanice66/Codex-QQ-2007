...
This project is derived from the macOS engine in [Fei-Away/Codex-Dream-Skin](https://github.com/Fei-Away/Codex-Dream-Skin), distributed under the MIT License. The repository license retains both Janice zhang's project notice and the upstream contributor notice; the original upstream license is also preserved in `macos/LICENSE`.
